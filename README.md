...
| 我的职责 | 负责需求分析、产品设计、系统架构、桌面端、AI 处理链路、授权后台和工程化发布的端到端实现 |
...
| 技术难点 | 处理思路 |
| --- | --- |
| 长视频识别结果与媒体时间轴对齐 | 将长音频分段处理并保留时间偏移，统一文稿字符、候选命中和视频播放位置的时间基准 |
| 目标词并非总能被 ASR 完整识别 | 组合精确匹配、拼音候选和上下文复核，提高口音、连读和识别波动下的候选召回能力 |
| 批量静音容易切断正常语音 | 在处理前后执行候选复核、边界检查和正常音频保护，并保留人工确认环节 |
...
本仓库是清影的**公开项目展示仓库**，用于求职作品展示、产品介绍、技术方案说明和试用入口维护，不包含完整产品源码，也不构成开源授权。
...
如需沟通项目技术、求职合作、产品试用或推广验证，请联系 **[718232157@qq.com](mailto:718232157@qq.com)**。
